...
def Add_Employees(fnam, mname, lname, password, authorization):
    mycursor.execute()
...
def Create_Tables():
    mycursor.execute("CREATE TABLE Employee (employee_id int PRIMARY KEY AUTO_INCREMENT,fname VARCHAR(50) NOT NULL, mname VARCHAR(50),lname VARCHAR(50) NOT NULL, password VARCHAR(50) NOT NULL, authorization smallint NOT NULL CHECK(authorization = '0' or authorization = '1' or authorization = '2'))")
